    ...
    <div className="my-20">
      ...
      <div className="flex flex-wrap items-center justify-evenly">
        ...
        <Link href="/mens-clothing">
          <div className=" m-10 flex h-[500px] w-[900px] items-center justify-center rounded-3xl bg-[#2BD9AF]">
        ...
        <Link href="/womens-clothing">
          <div className="m-10 flex h-[500px] w-[900px] items-center justify-center rounded-3xl bg-[#FF5E84]">
